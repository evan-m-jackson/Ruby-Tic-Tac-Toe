...
describe '#Game' do
    ...
    it "Player X picks then Player O picks" do
        ...
        game.change_marker
        game.mark_board('3')
        expect(game.board).to eq (['1','2','O','X','5','6','7','8','9'])
    end
    ...
    it "message prints if a spot is taken" do
        game = Game.new
        game.mark_board('1')
        expect{game.move_confirmation('1')}.to output("Sorry this space is taken. Please select another.\n").to_stdout
    end
